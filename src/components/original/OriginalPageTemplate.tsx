    ...
    <main className="source-page">
      ...
      <section className="source-page-hero">
        <div className="source-shell source-page-hero-grid">
          ...
          <div className="source-page-intro">
            ...
            <a href="tel:+34699242581">Hablar con un asesor · 699 24 25 81</a>
          </div>
        </div>
      </section>
      ...
      {products.length > 0 && (
        <section className="source-shell source-linked-products" aria-labelledby="source-products-heading">
          ...
          <div className="source-vehicle-grid">
            {products.map((product) => <OriginalVehicleCard product={product} key={product.path} />)}
          </div>
        </section>
      )}
